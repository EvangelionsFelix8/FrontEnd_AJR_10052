<template>
    <v-main class="list">
        ...
        <div style="margin-top: 25px;" v-if="(this.count - this.countDone) == 0">
            ...
            <h1 style="font-size: 45px; text-align: center; position: relative;"> Oops!</h1>
            <v-img style=" margin-left: auto; margin-right: auto ; position: relative;" 
                :src="emptyTransaksi" max-width="350" max-height="350">
            </v-img>
            <h2 style="text-align: center; position: relative;" mb-5> Tidak Ada Transaksi yang Berjalan, silakan lakukan transaksi Baru</h2>
            <v-icon size="45" style="position: fixed; bottom: 0; right: 0; margin: 0 120px 40px 0px;" color="#00396c">mdi-arrow-right</v-icon>
            <v-icon size="45" style="position: fixed; bottom: 0; right: 0; margin: 0 180px 40px 0px;" color="yellow darken-4">mdi-arrow-right</v-icon>
...
import jspdf from 'jspdf'
    export default {
        ...
        data(){
            return {
                emptyTransaksi: require('@/assets/Saly-32.png'),
